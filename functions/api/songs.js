...
// Use the full version of Firestore to ensure stability for all operations
import { getFirestore, doc, getDoc, setDoc, collection, getDocs, query, where, orderBy, deleteDoc } from 'firebase/firestore';
